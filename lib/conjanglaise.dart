...
class BaseDeDonne {
  static const dbName = "conjanglais";
  static const dbVersion = 1;
  static const dbTable = "smsconjanglais";
  static const columnId = "ideconjanglais";
  static const columnName = "namesconjanglais";
...
class conjanglais extends StatefulWidget {
  final String chatName;
  final int index;
  final bool isDarkModeEnabled;
  conjanglais({required this.chatName, required this.index, required this.isDarkModeEnabled});

  @override
  conjanglaisState createState() => conjanglaisState();
}

class conjanglaisState extends State<conjanglais> with SingleTickerProviderStateMixin {
  // Liste des messages
  ...
  Future<void> initializeData() async {
    ...
    String welcomeMessage = "Bienvenue à vous 😁! \nJe suis ici pour vous aider à trouver les conjuguaison de vos verbes en anglais. N'hésitez pas à poser vos questions.";
  ...
  void _handleSubmitted(String text) async {
    ...
    String url = "https://www.gymglish.com/fr/conjugaison/anglais/search?verb=to+$text";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        dom.Element? definitionElement = document.querySelector('.conjugation-mode');
        dom.Element? definitionElements = document.querySelector('.col-6 col-lg-4');
        if (definitionElement != null && definitionElements != null ) {
          String definitionsText = definitionElement.text +"          "+ definitionElements.text;
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: "Ecrire un verbe en anglais sans le 'To'",
                              ),
                            ),
                          ),
                          IconButton(
              ...
              Tab(
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    color: widget.isDarkModeEnabled ? Colors.white : Colors.lightGreen,
                  ),
                ), ),
              Tab(
                child: Text(
