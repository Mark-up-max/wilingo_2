...
class BaseDeDonne {
  static const dbName = "conjespagnol";
  static const dbVersion = 1;
  static const dbTable = "smseconjespagnol";
  static const columnId = "ideconjespagnol";
  static const columnName = "namesconjespagnol";
...
class conjespagnol extends StatefulWidget {
  final String chatName;
  final int index;
  final bool isDarkModeEnabled;
  conjespagnol({required this.chatName, required this.index, required this.isDarkModeEnabled});

  @override
  conjespagnolState createState() => conjespagnolState();
}

class conjespagnolState extends State<conjespagnol> with SingleTickerProviderStateMixin {
  // Liste des messages
  ...
  Future<void> initializeData() async {
    ...
    String welcomeMessage = "Bienvenue à vous ! 😁 \nJe suis ici pour vous aider à trouver les conjuguaisons de vos verbes en espagnole. N'hésitez pas à poser vos questions.";
  ...
  void _handleSubmitted(String text) async {
    ...
    String url = "https://www.larousse.fr/conjugaison/espagnol/$text";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        dom.Element? definitionElement = document.querySelector('#indicativo');
        ...
        dom.Element? definitionssElement = document.querySelector('#subjuntivo');
        ...
        dom.Element? definitionsssElement = document.querySelector('#condicional');
        ...
        dom.Element? definitionssssElement = document.querySelector('#imperativo');
        ...
        dom.Element? definitionsssssElement = document.querySelector('#infinitivo');
        ...
        dom.Element? definitionsElement = document.querySelector('#participio');
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Ecrire un verbe en espagnol',
                              ),
                            ),
                          ),
                          IconButton(
