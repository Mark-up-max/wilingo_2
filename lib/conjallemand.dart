...
class BaseDeDonne {
  static const dbName = "conjallemand";
  static const dbVersion = 1;
  static const dbTable = "smseconjallemand";
  static const columnId = "ideconjallemand";
  static const columnName = "namesconjallemand";
...
class conjallemand extends StatefulWidget {
  final String chatName;
  final int index;
  final bool isDarkModeEnabled;
  conjallemand({required this.chatName, required this.index, required this.isDarkModeEnabled});

  @override
  conjallemandState createState() => conjallemandState();
}

class conjallemandState extends State<conjallemand> with SingleTickerProviderStateMixin {
  // Liste des messages
  ...
  Future<void> initializeData() async {
    ...
    String welcomeMessage = "Bienvenue à vous ! 😁 \nJe suis ici pour vous aider à trouver les conjuguaisons de vos verbes en allemand. N'hésitez pas à poser vos questions.";
  ...
  void _handleSubmitted(String text) async {
    ...
    String url = "https://www.larousse.fr/conjugaison/allemand/$text";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        dom.Element? definitionElement = document.querySelector('#indikativ');
        ...
        dom.Element? definitionssElement = document.querySelector('#konjunktiv1');
        ...
        dom.Element? definitionsssElement = document.querySelector('#konjunktiv2');
        ...
        dom.Element? definitionssssElement = document.querySelector('#imperativ');
        ...
        dom.Element? definitionsssssElement = document.querySelector('#infinitiv');
        ...
        dom.Element? definitionsElement = document.querySelector('#partizip');
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          children: [
            CircleAvatar(
              backgroundImage: AssetImage('images/imagesconj.jpg'),
            ),
            SizedBox(width: 8.0),
            Text( 'Conj - Allem.. ',
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Ecrire un verbe en allemand',
                              ),
                            ),
                          ),
                          IconButton(
  ...
  Widget build(BuildContext context) {
    ...
    final messageBubble = GestureDetector(
      ...
      child: Container(
        padding: EdgeInsets.all(8.0),
        decoration: BoxDecoration(
          color: isUserMessage ? Colors.white : Colors.purpleAccent,
          borderRadius: BorderRadius.circular(16.0),
          boxShadow: [
            BoxShadow(
              color: Colors.black.withOpacity(0.2),
        ...
        child: GestureDetector(
          ...
          child: ListTile(
            leading: message.isUserMessage
                ? Icon(Icons.access_time_outlined, color: Colors.purpleAccent)
