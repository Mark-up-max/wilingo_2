...
class italien extends StatefulWidget {
  final String chatName;
  final int index;
  final bool isDarkModeEnabled;
  italien({required this.chatName, required this.index, required this.isDarkModeEnabled});

  @override
  italienState createState() => italienState();
}

class italienState extends State<italien> with SingleTickerProviderStateMixin {
  // Liste des messages
  ...
  Future<void> initializeData() async {
    ...
    String welcomeMessage = "Bienvenue ! 😁\nJe suis là pour vous aider à trouver les définitions des mots en français-italien. N'hésitez pas à poser vos questions.";
  ...
  void _handleSubmitted(String text) async {
    ...
    String url = isFrancaisItalien
        ? "https://www.larousse.fr/dictionnaires/francais-italien/$text"
        : "https://www.larousse.fr/dictionnaires/italien-francais/$text";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (definitionsElement != null) {
          ...
          String errorMessageIta = "Mi dispiace, ma non capisco la tua parola 😅. \n -Controllala se possibile, sono molto più efficace se le parole vengono inserite una per volta. \n -Potrebbe anche essere un malfunzionamento legato ai miei servizi. In tal caso, ti prego di pazientare.";
          ChatMessage aiMessage = ChatMessage(
            text: isFrancaisItalien ? errorMessage : errorMessageIta,
            isUserMessage: false,
            time: DateTime.now(),
      ...
      String errorMessageIta = "Mi dispiace 😥, controlla la tua connessione internet per favore.";
      ChatMessage aiMessage = ChatMessage(
        text: isFrancaisItalien ? errorMessage : errorMessageIta,
        isUserMessage: false,
        time: DateTime.now(),
      ...
      appBar:  AppBar(
        ...
        title: Row(
          children: [
            ...
            SizedBox(width: 8.0),
            Text(isFrancaisItalien ? 'Français - Itali.' : 'Italiano - Franc..',
              style: TextStyle(
        ...
        actions: [
            ...
            itemBuilder: (BuildContext context) => [
              PopupMenuItem(
                child: ListTile(
                  ...
                  title: Text(isFrancaisItalien ? 'Historique des discussions' : 'Cronologia delle conversazioni',
                    style: TextStyle(
                        color: Colors.white),
                  ),
                  onTap: () async {
          ...
          PopupMenuItem(
            child: ListTile(
              ...
              title: Text(isFrancaisItalien ? 'Italien : Français' : 'Francese - Italiano',
                style: TextStyle(
                    color: Colors.white),
              ),
              onTap: () {
                ...
                setState(() {
                  _messages[0] = ChatMessage(
                    text: "Super ! 😁 Nous passons à nouveau au français. je vais vous aider à trouver les définitions des mots en français-italien. \nN'hésitez pas à poser vos questions.",
                    isUserMessage: false,
                    time: DateTime.now(),
                    soundUrl: "",
                  );
                  ...
                  _messages[0] = ChatMessage(
                    text: "Super ! 😁 Nous passons à présent à l'italien. \nTi aiuterò a trovare le definizioni delle parole in italiano-francese. \nNon esitare a fare domande." ,
                    isUserMessage: false,
                    time: DateTime.now(),
                    soundUrl: "",
                  );
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: isFrancaisItalien ? 'Ecrire un mot en français' : '"Scrivi una parola in italiano.',
                              ),
                            ),
                          ),
                          IconButton(
  ...
  Widget build(BuildContext context) {
    ...
    final messageBubble = GestureDetector(
      ...
      child: Container(
        padding: EdgeInsets.all(8.0),
        decoration: BoxDecoration(
          color: isUserMessage ? Colors.white : Colors.lightGreen,
          borderRadius: BorderRadius.circular(16.0),
          boxShadow: [
            BoxShadow(
              color: Colors.black.withOpacity(0.2),
        ...
        child: GestureDetector(
          ...
          child: ListTile(
            leading: message.isUserMessage
                ? Icon(Icons.access_time_outlined, color: Colors.lightGreen)
