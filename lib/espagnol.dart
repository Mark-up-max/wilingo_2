...
class espagnolState extends State<espagnol> with SingleTickerProviderStateMixin {
  ...
  Future<void> initializeData() async {
    ...
    String welcomeMessage = "Bienvenue ! 😁\nJe suis là pour vous aider à trouver les définitions des mots en français-espagnol. N'hésitez pas à poser vos questions.";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (definitionsElement != null) {
          ...
          String errorMessageEsp = "Lo siento, pero no entiendo tu palabra 😅. \n-Verifícala si es posible, soy mucho más eficiente si las palabras se ingresan una por una. \n-También puede ser un problema relacionado con mis servicios. En ese caso, por favor, ten paciencia.";
          ChatMessage aiMessage = ChatMessage(
      ...
      String errorMessageEsp = "Lo siento 😥, por favor verifica tu conexión a internet.";
      ChatMessage aiMessage = ChatMessage(
        text: isFrancaisItalien ? errorMessage : errorMessageEsp,
        isUserMessage: false,
        time: DateTime.now(),
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            SizedBox(width: 8.0),
            Text(isFrancaisItalien ? 'Français - Esp...' : 'Español - Fran..',
            ...
            itemBuilder: (BuildContext context) => [
              ...
              PopupMenuItem(
                child: ListTile(
                  ...
                  title: Text(isFrancaisItalien ? 'Francés - Español' : 'Espagnol - Français' ,
                    style: TextStyle(
                        color: Colors.white),
                  ),
                  onTap: () {
                    ...
                    setState(() {
                      _messages[0] = ChatMessage(
                        text: "Super ! 😁 Nous passons à nouveau au français. je vais vous aider à trouver les définitions des mots en français-espagnol. \nN'hésitez pas à poser vos questions.",
                        isUserMessage: false,
                        time: DateTime.now(),
                        soundUrl: "",
                      );
                      ...
                      _messages[0] = ChatMessage(
                        text: "Super ! 😁 Nous passons à présent a l'espagnole. \nVoy a ayudarte a encontrar las definiciones de las palabras en español-francés. \nNo dudes en hacer tus preguntas." ,
                        isUserMessage: false,
                        time: DateTime.now(),
                        soundUrl: "",
                      );
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: isFrancaisItalien ? 'Ecrire un mot en français' : 'Escribe una palabra en español',
                              ),
                            ),
                          ),
                          IconButton(
