...
class anglais extends StatefulWidget {
  ...
  anglais({required this.chatName, required this.index, required this.isDarkModeEnabled});

  @override
  anglaisState createState() => anglaisState();
}

class anglaisState extends State<anglais> with SingleTickerProviderStateMixin {
  // Liste des messages
  ...
  Future<void> initializeData() async {
    ...
    String welcomeMessage = "Bienvenue ! 😁\nJe suis là pour vous aider à trouver les définitions des mots en français-anglais. N'hésitez pas à poser vos questions.";
  ...
  void _handleSubmitted(String text) async {
    ...
    String url = isFrancaisItalien
        ? "https://www.larousse.fr/dictionnaires/francais-anglais/$text"
        : "https://www.larousse.fr/dictionnaires/anglais-francais/$text";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (definitionsElement != null) {
          ...
          String errorMessageAng = "Sorry, but I don't understand your word 😅. \n -Please check it if possible, I am much more effective if the words are entered one by one. \n -It could also be a malfunction related to my services. In that case, please be patient.";
          ChatMessage aiMessage = ChatMessage(
            text: isFrancaisItalien ? errorMessage : errorMessageAng,
            isUserMessage: false,
            time: DateTime.now(),
      ...
      String errorMessageAng = "Sorry 😥, please check your internet connection.";
      ChatMessage aiMessage = ChatMessage(
        text: isFrancaisItalien ? errorMessage : errorMessageAng,
        isUserMessage: false,
        time: DateTime.now(),
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          children: [
            CircleAvatar(
              backgroundImage: AssetImage('images/télécharger.jpg'),
            ),
            SizedBox(width: 8.0),
            Text(isFrancaisItalien ? 'Français - Anglais' : 'English- Fren..',
            ...
            itemBuilder: (BuildContext context) => [
              PopupMenuItem(
                child: ListTile(
                  ...
                  title: Text( isFrancaisItalien ? 'Historique des discussions' : 'Chat history',
                    style: TextStyle(
                        color: Colors.white),
                  ),
                  onTap: () async {
              ...
              PopupMenuItem(
                child: ListTile(
                  ...
                  title: Text(isFrancaisItalien ? 'French - English' : 'Anglais - Français',
                    style: TextStyle(
                        color: Colors.white),
                  ),
                  onTap: () {
                    ...
                    setState(() {
                      _messages[0] = ChatMessage(
                        text: "Super ! 😁 Nous passons à nouveau au français. je vais vous aider à trouver les définitions des mots en français-anglais. \nN'hésitez pas à poser vos questions.",
                        isUserMessage: false,
                        time: DateTime.now(),
                        soundUrl: "",
                      );
                      ...
                      _messages[0] = ChatMessage(
                        text: "Super ! 😁 Nous passons à présent a l'anglais. \nI will help you find the definitions of words in english-french. \nFeel free to ask your questions." ,
                        isUserMessage: false,
                        time: DateTime.now(),
                        soundUrl: "",
                      );
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: isFrancaisItalien ? 'Ecrire un mot en français' : 'Write a word in English.',
                              ),
                            ),
                          ),
                          IconButton(
